...
public class Movimiento implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "id_dependiente") // Mapea la columna id_dependiente
    private Usuario dependiente; // Al objeto Usuario
    ...
    public Usuario getDependiente() {
        return dependiente;
    }

    public void setDependiente(Usuario dependiente) {
